"""
eoxyribonucleic acid, DNA is the primary information storage molecule in biological systems. 
...
from DNA its chemical structure and contains no Thymine. In RNA Thymine is 
